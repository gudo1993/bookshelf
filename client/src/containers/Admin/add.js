        ...
        return (
            <div className="rl_container article">
                <form onSubmit={this.submitForm}>   
                    ...
                    <textarea type="text" placeholder="Reviews" value={this.state.formdata.review} onChange={(event) => this.handleInput(event, 'review')} >
                    </textarea>
                    <div className="form_element">
                        <input type="text" placeholder="Enter Pages" value={this.state.formdata.pages} onChange={(event) => this.handleInput(event, 'pages')}/>
                    </div>
                    <div className="form_element">
